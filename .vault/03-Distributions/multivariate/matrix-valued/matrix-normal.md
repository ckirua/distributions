...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Matrix%5Fnormal%5Fdistribution
chart: assets/charts/matrix-normal.svg
code_status: none
code_symbols: {}
tags:
...
> Matrix normal distribution: A distribution over random matrices (covariance-like objects).

## When you meet it

- Specialized models where matrix normal structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Matrix%5Fnormal%5Fdistribution) for the standard parameterization and density or mass function.
...
![[matrix-normal chart|400]](assets/charts/matrix-normal.svg)
