...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Laplace%5Fdistribution
chart: assets/charts/laplace.svg
code_status: none
code_symbols: {}
tags:
...
> Laplace distribution: A continuous random variable with support on the entire real line.

## When you meet it

- Specialized models where laplace structure appears — see Wikipedia for domain examples.
...
![[laplace chart|400]](assets/charts/laplace.svg)
