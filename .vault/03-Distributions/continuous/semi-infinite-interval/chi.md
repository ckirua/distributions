...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Chi%5Fdistribution
chart: assets/charts/chi.svg
code_status: none
code_symbols: {}
tags:
...
> Chi distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where chi structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Chi%5Fdistribution) for the standard parameterization and density or mass function.
...
![[chi chart|400]](assets/charts/chi.svg)
