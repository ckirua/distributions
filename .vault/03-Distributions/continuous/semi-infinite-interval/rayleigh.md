...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Rayleigh%5Fdistribution
chart: assets/charts/rayleigh.svg
code_status: none
code_symbols: {}
tags:
...
> Rayleigh distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where rayleigh structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Rayleigh%5Fdistribution) for the standard parameterization and density or mass function.
...
![[rayleigh chart|400]](assets/charts/rayleigh.svg)
