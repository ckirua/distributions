...
> _F_ distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where _f_ structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/F-distribution) for the standard parameterization and density or mass function.
...
![[f chart|400]](assets/charts/f.svg)
