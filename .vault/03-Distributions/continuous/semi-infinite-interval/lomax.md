...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Lomax%5Fdistribution
chart: assets/charts/lomax.svg
code_status: none
code_symbols: {}
tags:
...
> Lomax distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where lomax structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Lomax%5Fdistribution) for the standard parameterization and density or mass function.
...
![[lomax chart|400]](assets/charts/lomax.svg)
