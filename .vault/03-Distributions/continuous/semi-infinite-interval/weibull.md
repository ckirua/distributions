...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Weibull%5Fdistribution
chart: assets/charts/weibull.svg
code_status: none
code_symbols: {}
tags:
...
> Weibull distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where weibull structure appears — see Wikipedia for domain examples.
...
![[weibull chart|400]](assets/charts/weibull.svg)
