...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Gamma%5Fdistribution
chart: assets/charts/gamma.svg
code_status: none
code_symbols: {}
tags:
...
> Gamma distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where gamma structure appears — see Wikipedia for domain examples.
...
![[gamma chart|400]](assets/charts/gamma.svg)
