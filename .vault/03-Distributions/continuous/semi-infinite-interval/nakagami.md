...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Nakagami%5Fdistribution
chart: assets/charts/nakagami.svg
code_status: none
code_symbols: {}
tags:
...
> Nakagami distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where nakagami structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Nakagami%5Fdistribution) for the standard parameterization and density or mass function.
...
![[nakagami chart|400]](assets/charts/nakagami.svg)
