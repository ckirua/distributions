...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Erlang%5Fdistribution
chart: assets/charts/erlang.svg
code_status: none
code_symbols: {}
tags:
...
> Erlang distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where erlang structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Erlang%5Fdistribution) for the standard parameterization and density or mass function.
...
![[erlang chart|400]](assets/charts/erlang.svg)
