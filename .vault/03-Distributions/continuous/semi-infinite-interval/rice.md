...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Rice%5Fdistribution
chart: assets/charts/rice.svg
code_status: none
code_symbols: {}
tags:
...
> Rice distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where rice structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Rice%5Fdistribution) for the standard parameterization and density or mass function.
...
> [!note] Visualization
> No bundled chart for this distribution. See [Wikipedia](https://en.wikipedia.org/wiki/Rice%5Fdistribution) or [[Support and domain]].
