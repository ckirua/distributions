...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Log-normal%5Fdistribution
chart: assets/charts/log-normal.svg
code_status: none
code_symbols: {}
tags:
...
> Log-normal distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where log-normal structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Log-normal%5Fdistribution) for the standard parameterization and density or mass function.
...
![[log-normal chart|400]](assets/charts/log-normal.svg)
