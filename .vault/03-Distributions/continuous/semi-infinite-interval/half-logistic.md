...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Half-logistic%5Fdistribution
chart: assets/charts/half-logistic.svg
code_status: none
code_symbols: {}
tags:
...
> Half-logistic distribution: A continuous random variable with support on a half-line such as [0,∞).

## When you meet it

- Specialized models where half-logistic structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Half-logistic%5Fdistribution) for the standard parameterization and density or mass function.
...
![[half-logistic chart|400]](assets/charts/half-logistic.svg)
