...
parameters: []
wikipedia: https://en.wikipedia.org/wiki/Benford%27s%5Flaw
chart: assets/charts/benford.svg
code_status: none
code_symbols: {}
tags:
...
> Benford distribution: A discrete random variable taking finitely many values.

## When you meet it

- Specialized models where benford structure appears — see Wikipedia for domain examples.
...
> [!note] Formula
> See the [Wikipedia article](https://en.wikipedia.org/wiki/Benford%27s%5Flaw) for the standard parameterization and density or mass function.
...
![[benford chart|400]](assets/charts/benford.svg)
