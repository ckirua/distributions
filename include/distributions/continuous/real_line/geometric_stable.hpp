...
struct GeometricStableDistribution {
    ...
    double loc_;
    double scale_;
    GeometricStableDistribution(double alpha, double beta, double loc, double scale) : alpha_(alpha), beta_(beta), loc_(loc), scale_(scale) {
...
using GeometricStable = GeometricStableDistribution<double>;
