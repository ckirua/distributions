...
.PHONY: help clean codegen configure configure-simd configure-simd512 build build-simd build-simd512 test test-simd test-simd512 test-sanity test-all bench bench-core bench-core-simd bench-core-baseline bench-core-quick bench-codegen bench-codegen-baseline bench-codegen-sweep bench-codegen-sweep-resume bench-all vault install
...
help:
	...
	@echo "  make bench-codegen-sweep — all 171 codegen ids → results/codegen-tier-a/"
...
bench-codegen-sweep: build
	$(PYTHON) bench/bench_codegen.py --sweep

bench-codegen-sweep-resume: build
	$(PYTHON) bench/bench_codegen.py --sweep --resume
